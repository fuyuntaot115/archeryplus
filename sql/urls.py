...
urlpatterns = [
    ...
    path("mssql_log_rollback/", mssql_log_rollback.mssql_log_rollback),
    path("mssql_log_rollback/databases/", mssql_log_rollback.mssql_log_rollback_databases),
    path("mssql_log_rollback/list/", mssql_log_rollback.mssql_log_rollback_list),
    path("mssql_log_rollback/schema/", mssql_log_rollback.mssql_log_rollback_schema),
    path("mssql_log_rollback/generate/", mssql_log_rollback.mssql_log_rollback_generate),
    path("server_merge/", server_merge.server_merge),
    path("server_merge/databases/", server_merge.server_merge_databases),
    path("server_merge/templates/", server_merge.server_merge_templates),
    path("server_merge/templates/save/", server_merge.server_merge_template_save),
    path("server_merge/templates/reset/", server_merge.server_merge_template_reset),
    path("server_merge/preview/", server_merge.server_merge_preview),
    path("server_merge/test_link/", server_merge.server_merge_test_link),
    path("server_merge/execute/", server_merge.server_merge_execute),
    path("server_merge/execute_all/", server_merge.server_merge_execute_all),
    path("server_merge/profile/save/", server_merge.server_merge_profile_save),
    path("server_merge/profile/list/", server_merge.server_merge_profile_list),
    path("server_merge/profile/load/", server_merge.server_merge_profile_load),
    path("server_merge/profile/delete/", server_merge.server_merge_profile_delete),
    path("server_merge/logs/", server_merge.server_merge_logs),
    ...
    path("slowquery/optimize_sql_ai/", sql.sql_optimize.optimize_sql_ai),
    ...
    path("db_diagnostic/mssql_databases/", db_diagnostic.mssql_databases),
